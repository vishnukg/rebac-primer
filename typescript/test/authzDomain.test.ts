// Unit tests for the AuthZ domain service (makeAuthzDomain) in isolation.
...
describe("makeAuthzDomain — check", () => {
    ...
    it("delegates the exact request to the evaluator (behaviour)", async () => {
        ...
        const domain = makeAuthzDomain({ repository: stubRepository(), evaluator });
...
describe("makeAuthzDomain — writeTuples", () => {
    it("writes each tuple to the repository in order (behaviour)", async () => {
        ...
        const domain = makeAuthzDomain({ repository, evaluator: stubEvaluator({ allowed: false, trace: [] }) });
...
describe("makeAuthzDomain — deleteTuples", () => {
...
describe("makeAuthzDomain — listTuples", () => {
