...
//
// handler.go maps HTTP routes to domain operations and translates domain errors
// to HTTP status codes.
//
// Mirrors typescript/src/documents-service/adapters/http/makeDocumentsHttpHandler.ts.
package http
