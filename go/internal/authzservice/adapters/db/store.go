...
// InMemoryTupleStore is a thread-safe, map-backed TupleRepository.
...
func (s *InMemoryTupleStore) FindAll(filter ...ports.TupleFilter) []shared.TupleKey {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
var _ ports.TupleRepository = (*InMemoryTupleStore)(nil)
...
func matchesFilter(k shared.TupleKey, f ports.TupleFilter) bool {
