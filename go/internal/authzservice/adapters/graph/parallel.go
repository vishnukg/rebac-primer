...
// It is satisfied by GraphEvaluator (via Evaluate) — allowing the concurrency
// helpers below to work with any evaluator adapter.
//
// Checker is identical to ports.Evaluator and can be used interchangeably.
type Checker = ports.Evaluator
