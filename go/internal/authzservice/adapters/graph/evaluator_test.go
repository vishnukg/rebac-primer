...
// Run with: go test -bench=. -benchtime=5s ./internal/authzservice/adapters/graph/...
...
// Run with: go test -fuzz=FuzzParseObject -fuzztime=30s ./internal/authzservice/adapters/graph/...
